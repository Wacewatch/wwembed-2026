...
"[project]/app/api/v1/download_links/media-types/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(req) {
    ...
    try {
        const db = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$mongo$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getDb"])();
        const types = await db.collection("download_links").distinct("media_type", __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$wavewatch$2d$api$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["BASE_FILTER"]);
        const cleaned = types.filter((t)=>typeof t === "string" && t.length > 0).sort();
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            types: cleaned
        });
    } catch (e) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__c4dec4a9._.js.map
...
"[project]/app/api/v1/profiles/uploaders/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(req) {
    ...
    try {
        ...
        const rawIds = await db.collection("download_links").distinct("submitted_by", __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$wavewatch$2d$api$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["BASE_FILTER"]);
        const ids = rawIds.filter((v)=>Boolean(v));
        if (ids.length === 0) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            uploaders: []
        });
        const objectIds = [];
        const stringIds = [];
        for (const v of ids){
            if (v instanceof __TURBOPACK__imported__module__$5b$externals$5d2f$mongodb__$5b$external$5d$__$28$mongodb$2c$__cjs$29$__["ObjectId"]) {
                ...
                if (/^[a-f0-9]{24}$/i.test(v)) {
                    try {
                        objectIds.push(new __TURBOPACK__imported__module__$5b$externals$5d2f$mongodb__$5b$external$5d$__$28$mongodb$2c$__cjs$29$__["ObjectId"](v));
                    } catch  {
                        stringIds.push(v);
                    }
                } else {
        ...
        const uploaders = docs.map((d)=>({
                username: d.username || null,
                role: d.role || null
            })).filter((u)=>u.username)// Stable sort, case-insensitive.
...
//# sourceMappingURL=%5Broot-of-the-server%5D__b1b38900._.js.map
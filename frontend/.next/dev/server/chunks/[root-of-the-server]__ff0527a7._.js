...
"[project]/app/api/v1/music/[wwId]/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request, { params }) {
    ...
    if (!wwId.startsWith("ww-music-")) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: "Invalid music WW ID format"
        }, {
            status: 400
        });
    }
    ...
    const { data: content } = await supabase.from("digital_content").select("*").eq("ww_id", wwId).eq("content_type", "music").eq("is_active", true).eq("status", "approved").single();
    if (!content) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
    ...
    const streamsJson = JSON.stringify(streamLinks.map((l, i)=>({
            name: l.source_name || `Piste ${i + 1}`,
            url: l.reader_url || l.source_url,
            format: l.file_format || "MP3"
        })));
    const downloadsJson = JSON.stringify(downloadLinks.map((l)=>({
            name: l.source_name,
            url: l.source_url,
            format: l.file_format || "MP3",
            size: l.file_size || ""
...
//# sourceMappingURL=%5Broot-of-the-server%5D__ff0527a7._.js.map
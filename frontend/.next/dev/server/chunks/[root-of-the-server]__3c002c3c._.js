...
"[project]/app/api/v1/download_links/for-content/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(req) {
    ...
    if (!Number.isFinite(tmdbId)) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: "Bad request",
            reason: "tmdb_id must be an integer"
        }, {
            status: 400
        });
    }
    ...
    if (mediaType === "tv") {
        if (seasonRaw != null && seasonRaw !== "") {
            ...
            if (!Number.isFinite(season)) {
                return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                    error: "Bad request",
                    reason: "season must be an integer"
                }, {
                    status: 400
                });
            }
            ...
            if (episodeRaw != null && episodeRaw !== "") {
                ...
                if (!Number.isFinite(episode)) {
                    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                        error: "Bad request",
                        reason: "episode must be an integer"
                    }, {
                        status: 400
                    });
                }
            ...
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: "Bad request",
                reason: "episode requires season"
            }, {
                status: 400
            });
        }
    ...
    try {
        ...
        const rank = (q)=>typeof q === "string" ? QUALITY_RANK[q.toLowerCase().trim()] ?? -1 : -1;
...
//# sourceMappingURL=%5Broot-of-the-server%5D__3c002c3c._.js.map
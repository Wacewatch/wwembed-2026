...
"[project]/app/api/v1/livetv/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    ...
    let query = supabase.from("live_tv_channels").select("id, channel_name, country, category, channel_logo, language").eq("is_active", true).eq("status", "approved");
...
//# sourceMappingURL=%5Broot-of-the-server%5D__69d24325._.js.map
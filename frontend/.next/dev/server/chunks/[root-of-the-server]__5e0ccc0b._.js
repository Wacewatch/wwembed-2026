...
"[project]/app/api/bug-reports/user/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    try {
        ...
        const { data, error } = await supabase.from("bug_reports").select("*").eq("user_id", user.id).order("created_at", {
            ascending: false
        });
        if (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__5e0ccc0b._.js.map
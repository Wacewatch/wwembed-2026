...
"[project]/app/api/bug-reports/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(request) {
    try {
        ...
        const { wwId, mediaType, tmdbId, seasonNumber, episodeNumber, title, sourceName, sourceUrl, message, embedType } = body;
        if (!wwId || !message) {
...
async function GET(request) {
    try {
        ...
        let query = supabase.from("bug_reports").select("*").order("created_at", {
            ascending: false
        });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__ff503c8a._.js.map
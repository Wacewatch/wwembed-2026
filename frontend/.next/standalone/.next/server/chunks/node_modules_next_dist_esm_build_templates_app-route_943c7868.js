module.exports=[50352,e=>{"use strict";var t=e.i(47909),a=e.i(74017),i=e.i(96250),n=e.i(59756),r=e.i(61916),o=e.i(14444),l=e.i(37092),d=e.i(69741),s=e.i(16795),c=e.i(87718),p=e.i(95169),u=e.i(47587),x=e.i(66012),f=e.i(70101),g=e.i(26937),b=e.i(10372),m=e.i(93695);e.i(52474);var v=e.i(220),h=e.i(89171),y=e.i(79314),k=e.i(12821);function w(e="x"){return e+Math.random().toString(36).substring(2,10)}async function _(e,{params:t}){let{wwId:a}=await t,i=e.nextUrl.searchParams.get("decode"),n=e.nextUrl.searchParams.get("title_id")||"";if(i){let t=e.headers.get("x-forwarded-for")?.split(",")[0].trim()||e.headers.get("x-real-ip")||"127.0.0.1",a=`https://still-wood-a206.wavewatchcontact.workers.dev/https://api.movix.cash/api/darkiworld/decode/${i}?title_id=${n}`;try{let e=await fetch(a,{headers:{"X-Forwarded-For":t,"X-Real-IP":t}}),i=await e.json();return h.NextResponse.json(i)}catch{return h.NextResponse.json({error:"decode_failed"},{status:500})}}let r=(0,y.createAdminClient)();if(a.startsWith("ww-ebook-")||a.startsWith("ww-music-")||a.startsWith("ww-software-")||a.startsWith("ww-soft-")||a.startsWith("ww-game-")){let t=null,{data:i}=await r.from("digital_content").select("*").eq("ww_id",a).single();if(i)t=i;else if(a.startsWith("ww-soft-")){let e=a.replace("ww-soft-","ww-software-"),{data:i}=await r.from("digital_content").select("*").eq("ww_id",e).single();i&&(t=i)}else if(a.startsWith("ww-software-")){let e=a.replace("ww-software-","ww-soft-"),{data:i}=await r.from("digital_content").select("*").eq("ww_id",e).single();i&&(t=i)}if(!t)return h.NextResponse.json({error:"Digital content not found"},{status:404});let{data:n}=await r.from("digital_download_links").select("*").eq("content_id",t.id).eq("is_active",!0).eq("status","approved").order("quality",{ascending:!1}),{data:o}=await r.from("ads").select("id, name, ad_url, ad_type").eq("is_active",!0),l=o&&o.length>0,d=l?o[0].ad_url:"",s=l?o[0].id:"",c=t.title,p=t.cover_url||"",u=t.content_type,x=n?.filter(e=>e.source_url)||[];await r.from("embed_views").insert({ww_id:a,embed_type:"download",referrer:e.headers.get("referer"),user_agent:e.headers.get("user-agent")});let f={container:w("ext"),loading:w("extl"),content:w("extc"),filters:w("extf"),count:w("extn"),altContent:w("exa"),altLoading:w("exal"),altCount:w("exac")},g={overlay:w("m"),container:w("c"),timer:w("t"),progress:w("g"),btnUnlock:w("u"),btnDownload:w("d"),boxTime:w("bt"),boxHelp:w("bh"),boxThanks:w("bk"),boxDone:w("bd"),step1:w("s1"),step2:w("s2"),step3:w("s3"),linksContainer:w("lc")},b=JSON.stringify(x||[]).replace(/'/g,"\\'").replace(/</g,"\\u003c"),m=`<!DOCTYPE html>
<html lang="fr">
<head>
<meta charset="UTF-8">
<meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=no">
<title>${c} - T\xe9l\xe9chargements WWEmbed</title>
<style>
...
<button class="ext-tab active" id="tabMovix" onclick="switchTab('movix')">
  ...
  Sources externes
  <span class="ext-tab-badge" id="${f.count}">...</span>
</button>
<button class="ext-tab" id="tabAlt" onclick="switchTab('alt')">
  <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polygon points="13 2 3 14 12 14 11 22 21 10 12 10 13 2"/></svg>
  Sources Alt
  <span class="ext-tab-badge" id="${f.altCount}">...</span>
</button>
</div>

<div id="${f.container}">
<div class="ext-loading" id="${f.loading}">
...
<div id="${f.filters}" class="ext-filters" style="display:none">
<select id="extQualityFilter" class="ext-select"><option value="">Qualit\xe9</option></select>
...
<div id="${f.content}" class="ext-grid"></div>
</div>

<div id="${f.altContent}_wrap" style="display:none">
<div class="ext-loading" id="${f.altLoading}">
<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M21 12a9 9 0 1 1-6.219-8.56"/></svg>
Recherche de sources alternatives...
</div>
<div id="${f.altContent}" class="ext-grid"></div>
</div>
...
<div class="mo" id="${g.overlay}">
<div class="mc">
<h2>Votre t\xe9l\xe9chargement est pr\xeat</h2>
<div class="mc-sub">Une derni\xe8re \xe9tape pour acc\xe9der au fichier</div>
<div class="steps">
<div class="step active" id="${g.step1}"></div>
<div class="step" id="${g.step2}"></div>
<div class="step" id="${g.step3}"></div>
</div>
<div class="bx bw">
<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="10"/><line x1="12" y1="8" x2="12" y2="12"/><line x1="12" y1="16" x2="12.01" y2="16"/></svg>
<div class="bx-content"><b>Popup requis</b><span>Autorisez les popups pour continuer</span></div>
</div>
<div class="bx bh" id="${g.boxHelp}">
<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z"/></svg>
<div class="bx-content"><b>Soutenez le service gratuit</b><span>Votre clic nous aide \xe0 rester en ligne</span></div>
</div>
<div class="bx bi" id="${g.boxTime}">
<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="10"/><polyline points="12 6 12 12 16 14"/></svg>
<div class="bx-content"><b>Temps restant: <span id="${g.timer}">3</span> seconde(s)</b><span>Cliquez et fermez la fen\xeatre</span></div>
</div>
<div class="bx bo hi" id="${g.boxThanks}">
<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M22 11.08V12a10 10 0 1 1-5.93-9.14"/><polyline points="22 4 12 14.01 9 11.01"/></svg>
<div class="bx-content"><b>Merci pour votre soutien !</b><span>Vous aidez \xe0 maintenir le service</span></div>
</div>
<div class="bx bo hi" id="${g.boxDone}">
...
<div class="bx-content"><b>Tout est pr\xeat !</b><span>Cliquez pour voir le lien</span></div>
</div>
<div class="pb"><div class="pf" id="${g.progress}"></div></div>
<a href="${d}" target="_blank" rel="noopener" class="bt bp" id="${g.btnUnlock}">CONTINUER<span class="tag">PUB</span></a>
<button class="bt bn hi" id="${g.btnDownload}">Voir le lien</button>
<div class="cf">Propuls\xe9 par <a href="https://wavewatch.top" target="_blank">WaveWatch</a></div>
</div>
</div>
...
var _h=${l};
var _p=null;
var _ids=${JSON.stringify(g)};
var _extIds=${JSON.stringify(f)};
var _title="${c.replace(/"/g,'\\"')}";
var _wwId="${t.ww_id}";
var _contentType="${u}";
var _allExtLinks=[];
...
function _showRateLimitModal(retryAt){
  ...
  box.innerHTML =
    ...
    'Propuls\xe9 par <a href="https://wavewatch.top" target="_blank" style="color:#60a5fa;text-decoration:none">WaveWatch</a>' +
    '</p>';
...
</html>`;return new h.NextResponse(m,{headers:{"Content-Type":"text/html; charset=utf-8","X-Frame-Options":"ALLOWALL","Access-Control-Allow-Origin":"*"}})}let o=(0,k.parseWWId)(a);if(!o)return h.NextResponse.json({error:"Invalid WW ID format"},{status:400});let{mediaType:l,tmdbId:d,seasonNumber:s,episodeNumber:c}=o,{data:p}=await r.from("ads").select("id, name, ad_url, ad_type").eq("is_active",!0),u=p&&p.length>0,x=u?p[0].ad_url:"",f=u?p[0].id:"",g="movie"===l?await (0,k.getMovieDetails)(d):await (0,k.getTVDetails)(d),b=g?"title"in g?g.title:g.name:"Unknown",m=g?.poster_path,v=m?(0,k.getPosterUrl)(m,"w185"):"",_=r.from("download_links").select("*, profiles:submitted_by (username)").eq("tmdb_id",d).eq("media_type",l).eq("is_active",!0).eq("status","approved");"tv"===l&&(void 0!==s&&void 0!==c?_=_.eq("season_number",s).eq("episode_number",c):void 0!==s&&(_=_.eq("season_number",s)));let{data:L}=await _.order("season_number",{ascending:!0}).order("episode_number",{ascending:!0}).order("quality",{ascending:!1});await r.from("embed_views").insert({ww_id:a,tmdb_id:d,media_type:l,season_number:s??null,episode_number:c??null,embed_type:"download",referrer:e.headers.get("referer"),user_agent:e.headers.get("user-agent")});let E={overlay:w("m"),timer:w("t"),progress:w("g"),btnUnlock:w("u"),btnDownload:w("d"),boxTime:w("bt"),boxHelp:w("bh"),boxThanks:w("bk"),boxDone:w("bd"),step1:w("s1"),step2:w("s2"),step3:w("s3"),linksContainer:w("lc")},A=JSON.stringify(L||[]).replace(/'/g,"\\'").replace(/</g,"\\u003c"),I="tv"===l,C={container:w("ext"),content:w("exc"),loading:w("exl"),filters:w("exf"),count:w("exn"),altContent:w("exa"),altLoading:w("exal"),altCount:w("exac")},T=`<!DOCTYPE html>
<html lang="fr">
<head>
<meta charset="UTF-8">
<meta name="viewport" content="width=device-width,initial-scale=1,maximum-scale=1,user-scalable=no">
<title>T\u00e9l\u00e9chargement - ${b}</title>
<style>
*{margin:0;padding:0;box-sizing:border-box}
body{font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,sans-serif;background:linear-gradient(135deg,#0a0f1a 0%,#111827 50%,#0f172a 100%);color:#e5e7eb;padding:16px;min-height:100vh}
.hd{display:flex;align-items:center;gap:16px;margin-bottom:20px;padding:16px;background:rgba(30,58,79,0.3);border-radius:12px;border:1px solid rgba(30,58,79,0.5)}
...
<body>
<div class="hd">
${v?`<img src="${v}" alt="${b}" class="ps">`:""}
<div>
<div class="tt">${b}</div>
<div class="tg">${"movie"===l?"Film":"Série"}</div>
</div>
</div>

<div id="${E.linksContainer}"></div>
...
<button class="ext-tab active" id="tabMovix" onclick="switchTab('movix')">
  <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="10"/><line x1="2" y1="12" x2="22" y2="12"/><path d="M12 2a15.3 15.3 0 0 1 4 10 15.3 15.3 0 0 1-4 10 15.3 15.3 0 0 1-4-10 15.3 15.3 0 0 1 4-10z"/></svg>
  Sources externes
  <span class="ext-tab-badge" id="${C.count}">...</span>
</button>
<button class="ext-tab" id="tabAlt" onclick="switchTab('alt')">
  <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polygon points="13 2 3 14 12 14 11 22 21 10 12 10 13 2"/></svg>
  Sources Alt
  <span class="ext-tab-badge" id="${C.altCount}">...</span>
</button>
</div>

<div id="${C.container}">
<div class="ext-loading" id="${C.loading}">
<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M21 12a9 9 0 1 1-6.219-8.56"/></svg>
Recherche de sources externes...
</div>
<div id="${C.filters}" class="ext-filters" style="display:none">
<select id="extQualityFilter" class="ext-select"><option value="">Qualit\u00e9</option></select>
<select id="extLanguageFilter" class="ext-select"><option value="">Langue</option></select>
<select id="extProviderFilter" class="ext-select"><option value="">Provider</option></select>
</div>
<div id="${C.content}" class="ext-grid"></div>
</div>

<div id="${C.altContent}_wrap" style="display:none">
<div class="ext-loading" id="${C.altLoading}">
<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M21 12a9 9 0 1 1-6.219-8.56"/></svg>
Recherche de sources alternatives...
</div>
<div id="${C.content}_altfilters" class="ext-filters" style="display:none">
...
<div id="${C.altContent}" class="ext-grid"></div>
</div>
...
<div class="mo" id="${E.overlay}">
<div class="mc">
<h2>Votre t\u00e9l\u00e9chargement est pr\u00eat</h2>
<div class="mc-sub">Une derni\u00e8re \u00e9tape pour acc\u00e9der au fichier</div>
<div class="steps">
<div class="step active" id="${E.step1}"></div>
<div class="step" id="${E.step2}"></div>
<div class="step" id="${E.step3}"></div>
</div>
<div class="bx bw">
<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="10"/><line x1="12" y1="8" x2="12" y2="12"/><line x1="12" y1="16" x2="12.01" y2="16"/></svg>
<div class="bx-content"><b>Popup requis</b><span>Autorisez les popups pour continuer</span></div>
</div>
<div class="bx bh" id="${E.boxHelp}">
<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z"/></svg>
<div class="bx-content"><b>Soutenez le service gratuit</b><span>Votre clic nous aide \u00e0 rester en ligne</span></div>
</div>
<div class="bx bi" id="${E.boxTime}">
<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="10"/><polyline points="12 6 12 12 16 14"/></svg>
<div class="bx-content"><b>Temps restant: <span id="${E.timer}">3</span> seconde(s)</b><span>Cliquez et fermez la fen\u00eatre</span></div>
</div>
<div class="bx bo hi" id="${E.boxThanks}">
<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M22 11.08V12a10 10 0 1 1-5.93-9.14"/><polyline points="22 4 12 14.01 9 11.01"/></svg>
<div class="bx-content"><b>Merci pour votre soutien !</b><span>Vous aidez \u00e0 maintenir le service</span></div>
</div>
<div class="bx bo hi" id="${E.boxDone}">
<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"/><polyline points="7 10 12 15 17 10"/><line x1="12" x2="12" y1="15" y2="3"/></svg>
<div class="bx-content"><b>Tout est pr\u00eat !</b><span>Cliquez pour voir le lien</span></div>
</div>
<div class="pb"><div class="pf" id="${E.progress}"></div></div>
<button class="bt bp" id="${E.btnUnlock}">Continuer<span class="tag">PUB</span></button>
<button class="bt bn hi" id="${E.btnDownload}">Voir le lien</button>
...
var _h=${u};
var _p=null;
var _ids=${JSON.stringify(E)};
var _extIds=${JSON.stringify(C)};
var _isSeries=${I};
var _title="${b.replace(/"/g,'\\"')}";
var _mediaType="${l}";
var _tmdbId=${d};
var _seasonNum=${void 0!==s?s:"null"};
var _episodeNum=${void 0!==c?c:"null"};
var _wwId="${a}";
var _allExtLinks=[];
var _currentExtLinks=[];
var _allAltLinks=[];
...
</html>`;return new h.NextResponse(T,{headers:{"Content-Type":"text/html; charset=utf-8","X-Frame-Options":"ALLOWALL","Access-Control-Allow-Origin":"*"}})}e.s(["GET",()=>_],11496);var L=e.i(11496);let E=new t.AppRouteRouteModule({definition:{kind:a.RouteKind.APP_ROUTE,page:"/api/v1/download/[wwId]/route",pathname:"/api/v1/download/[wwId]",filename:"route",bundlePath:""},distDir:".next",relativeProjectDir:"",resolvedPagePath:"[project]/app/api/v1/download/[wwId]/route.ts",nextConfigOutput:"standalone",userland:L}),{workAsyncStorage:A,workUnitAsyncStorage:I,serverHooks:C}=E;function T(){return(0,i.patchFetch)({workAsyncStorage:A,workUnitAsyncStorage:I})}async function B(e,t,i){E.isDev&&(0,n.addRequestMeta)(e,"devRequestTimingInternalsEnd",process.hrtime.bigint());let h="/api/v1/download/[wwId]/route";h=h.replace(/\/index$/,"")||"/";let y=await E.prepare(e,t,{srcPage:h,multiZoneDraftMode:!1});if(!y)return t.statusCode=400,t.end("Bad Request"),null==i.waitUntil||i.waitUntil.call(i,Promise.resolve()),null;let{buildId:k,params:w,nextConfig:_,parsedUrl:L,isDraftMode:A,prerenderManifest:I,routerServerContext:C,isOnDemandRevalidate:T,revalidateOnlyGenerated:B,resolvedPathname:q,clientReferenceManifest:R,serverActionsManifest:z}=y,S=(0,d.normalizeAppPath)(h),M=!!(I.dynamicRoutes[S]||I.routes[q]),U=async()=>((null==C?void 0:C.render404)?await C.render404(e,t,L,!1):t.end("This page could not be found"),null);if(M&&!A){let e=!!I.routes[q],t=I.dynamicRoutes[S];if(t&&!1===t.fallback&&!e){if(_.experimental.adapterPath)return await U();throw new m.NoFallbackError}}let N=null;!M||E.isDev||A||(N="/index"===(N=q)?"/":N);let F=!0===E.isDev||!M,P=M&&!F;z&&R&&(0,o.setReferenceManifestsSingleton)({page:h,clientReferenceManifest:R,serverActionsManifest:z,serverModuleMap:(0,l.createServerModuleMap)({serverActionsManifest:z})});let D=e.method||"GET",O=(0,r.getTracer)(),H=O.getActiveScopeSpan(),$={params:w,prerenderManifest:I,renderOpts:{experimental:{authInterrupts:!!_.experimental.authInterrupts},cacheComponents:!!_.cacheComponents,supportsDynamicResponse:F,incrementalCache:(0,n.getRequestMeta)(e,"incrementalCache"),cacheLifeProfiles:_.cacheLife,waitUntil:i.waitUntil,onClose:e=>{t.on("close",e)},onAfterTaskError:void 0,onInstrumentationRequestError:(t,a,i)=>E.onRequestError(e,t,i,C)},sharedContext:{buildId:k}},j=new s.NodeNextRequest(e),V=new s.NodeNextResponse(t),W=c.NextRequestAdapter.fromNodeNextRequest(j,(0,c.signalFromNodeResponse)(t));try{let o=async e=>E.handle(W,$).finally(()=>{if(!e)return;e.setAttributes({"http.status_code":t.statusCode,"next.rsc":!1});let a=O.getRootSpanAttributes();if(!a)return;if(a.get("next.span_type")!==p.BaseServerSpan.handleRequest)return void console.warn(`Unexpected root span type '${a.get("next.span_type")}'. Please report this Next.js issue https://github.com/vercel/next.js`);let i=a.get("next.route");if(i){let t=`${D} ${i}`;e.setAttributes({"next.route":i,"http.route":i,"next.span_name":t}),e.updateName(t)}else e.updateName(`${D} ${h}`)}),l=!!(0,n.getRequestMeta)(e,"minimalMode"),d=async n=>{var r,d;let s=async({previousCacheEntry:a})=>{try{if(!l&&T&&B&&!a)return t.statusCode=404,t.setHeader("x-nextjs-cache","REVALIDATED"),t.end("This page could not be found"),null;let r=await o(n);e.fetchMetrics=$.renderOpts.fetchMetrics;let d=$.renderOpts.pendingWaitUntil;d&&i.waitUntil&&(i.waitUntil(d),d=void 0);let s=$.renderOpts.collectedTags;if(!M)return await (0,x.sendResponse)(j,V,r,$.renderOpts.pendingWaitUntil),null;{let e=await r.blob(),t=(0,f.toNodeOutgoingHttpHeaders)(r.headers);s&&(t[b.NEXT_CACHE_TAGS_HEADER]=s),!t["content-type"]&&e.type&&(t["content-type"]=e.type);let a=void 0!==$.renderOpts.collectedRevalidate&&!($.renderOpts.collectedRevalidate>=b.INFINITE_CACHE)&&$.renderOpts.collectedRevalidate,i=void 0===$.renderOpts.collectedExpire||$.renderOpts.collectedExpire>=b.INFINITE_CACHE?void 0:$.renderOpts.collectedExpire;return{value:{kind:v.CachedRouteKind.APP_ROUTE,status:r.status,body:Buffer.from(await e.arrayBuffer()),headers:t},cacheControl:{revalidate:a,expire:i}}}}catch(t){throw(null==a?void 0:a.isStale)&&await E.onRequestError(e,t,{routerKind:"App Router",routePath:h,routeType:"route",revalidateReason:(0,u.getRevalidateReason)({isStaticGeneration:P,isOnDemandRevalidate:T})},C),t}},c=await E.handleResponse({req:e,nextConfig:_,cacheKey:N,routeKind:a.RouteKind.APP_ROUTE,isFallback:!1,prerenderManifest:I,isRoutePPREnabled:!1,isOnDemandRevalidate:T,revalidateOnlyGenerated:B,responseGenerator:s,waitUntil:i.waitUntil,isMinimalMode:l});if(!M)return null;if((null==c||null==(r=c.value)?void 0:r.kind)!==v.CachedRouteKind.APP_ROUTE)throw Object.defineProperty(Error(`Invariant: app-route received invalid cache entry ${null==c||null==(d=c.value)?void 0:d.kind}`),"__NEXT_ERROR_CODE",{value:"E701",enumerable:!1,configurable:!0});l||t.setHeader("x-nextjs-cache",T?"REVALIDATED":c.isMiss?"MISS":c.isStale?"STALE":"HIT"),A&&t.setHeader("Cache-Control","private, no-cache, no-store, max-age=0, must-revalidate");let p=(0,f.fromNodeOutgoingHttpHeaders)(c.value.headers);return l&&M||p.delete(b.NEXT_CACHE_TAGS_HEADER),!c.cacheControl||t.getHeader("Cache-Control")||p.get("Cache-Control")||p.set("Cache-Control",(0,g.getCacheControlHeader)(c.cacheControl)),await (0,x.sendResponse)(j,V,new Response(c.value.body,{headers:p,status:c.value.status||200})),null};H?await d(H):await O.withPropagatedContext(e.headers,()=>O.trace(p.BaseServerSpan.handleRequest,{spanName:`${D} ${h}`,kind:r.SpanKind.SERVER,attributes:{"http.method":D,"http.target":e.url}},d))}catch(t){if(t instanceof m.NoFallbackError||await E.onRequestError(e,t,{routerKind:"App Router",routePath:S,routeType:"route",revalidateReason:(0,u.getRevalidateReason)({isStaticGeneration:P,isOnDemandRevalidate:T})}),M)throw t;return await (0,x.sendResponse)(j,V,new Response(null,{status:500})),null}}e.s(["handler",()=>B,"patchFetch",()=>T,"routeModule",()=>E,"serverHooks",()=>C,"workAsyncStorage",()=>A,"workUnitAsyncStorage",()=>I],50352)}];

//# sourceMappingURL=node_modules_next_dist_esm_build_templates_app-route_943c7868.js.map
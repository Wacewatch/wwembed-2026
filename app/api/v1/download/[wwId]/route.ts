...
var s=_seasonNum||1;
var e=_episodeNum||1;
dlUrl="https://still-wood-a206.wavewatchcontact.workers.dev/https://api.movix.cash/api/darkiworld/download/tv/"+movieId+"?season="+s+"&episode="+e;
}else{
dlUrl="https://still-wood-a206.wavewatchcontact.workers.dev/https://api.movix.cash/api/darkiworld/download/movie/"+movieId;
}

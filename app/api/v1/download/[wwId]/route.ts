...
html+='<div class="ext-stat">';
html+='<div class="ext-stat-label">Taille</div>';
html+='<div class="ext-stat-value">'+_formatSize(l.file_size)+'</div>';
html+='</div>';
html+='<div class="ext-stat">';
html+='<div class="ext-stat-label">Provider</div>';
html+='<div class="ext-stat-value">'+(l.provider||"Inconnu")+'</div>';
html+='</div>';
html+='</div>';
html+='<button class="ext-btn" onclick="window.open(\''+encodeURIComponent(l.source_url || "")+'\', \'_blank\')">Télécharger</button>';
html+='</div></div>';
});
content.innerHTML=html;
  ...
  // Handle other types of content here if needed
